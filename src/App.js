...
class App extends Component {
  ...
  render() {
    const { isAuthenticated, location, setOpenModal } = this.props;
    ...
    let routes = (
      <Switch>
        ...
        <Route
          path="/track/overview"
          render={() => <Content component={<Overview isAuthenticated={isAuthenticated} setOpenModal={setOpenModal} />} location={location} />}
        />
        <Route
          path="/track/follow-ups"
          render={() => <Content component={<FollowUps isAuthenticated={isAuthenticated} setOpenModal={setOpenModal} />} location={location} />}
        />
        <Route
          path="/track/interviews"
          render={() => <Content component={<Interviews isAuthenticated={isAuthenticated} setOpenModal={setOpenModal} />} location={location} />}
        />
        <Route
          path="/analyze/applications"
          render={() => <Content component={<Applications isAuthenticated={isAuthenticated} setOpenModal={setOpenModal} />} location={location} />}
        />
        <Route
        ...
        <Route
          path="/"
          exact
          render={() => <Content component={<Home isAuthenticated={isAuthenticated} setOpenModal={setOpenModal} />} location={location} />}
        />
        <Redirect to="/" />
      </Switch>
    )
